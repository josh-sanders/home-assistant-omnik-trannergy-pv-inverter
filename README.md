...
I do not use this component myself anymore and do not have the time to maintain it.
Therefore I archive this component. You are free to use this codebase in future components.
